...
{
    /// <summary>
    /// Retrieves elements from a rank 1 arrayfire array reshaped into the form of the
    /// indices.
    /// </summary>
    /// <param name="m">- The rank 1 arrayfire array to get elements from.</param>
    /// <param name="i">- The indices of the elements to retrieve.</param>
    /// <returns>Elements of m indexed by, and in the shape of, i.</returns>
    ...
    {
        const auto pHost{toPointer<T>(m)};
